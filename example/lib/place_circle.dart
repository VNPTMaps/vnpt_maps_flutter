...
class PlaceCirclePage extends VNPTMapExamplePage {
  const PlaceCirclePage() : super(const Icon(Icons.circle), 'Place circle');
...
class PlaceCircleBodyState extends State<PlaceCircleBody> {
  ...
  static const LatLng center = LatLng(10.800302, 106.667398);
