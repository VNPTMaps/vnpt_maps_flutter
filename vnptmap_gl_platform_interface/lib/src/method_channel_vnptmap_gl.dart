...
class MethodChannelVNPTMapGl extends VNPTMapGlPlatform {
  ...
  Future<dynamic> _handleMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case 'map#onMapLongClick':
        ...
        break;
      case 'marker#onTap':
        onMarkerTapPlatform(MarkerId(call.arguments['markerId']));
        break;
      case 'infoWindow#onTap':
        ...
        onInfoWindowTapPlatform(MarkerId(call.arguments['markerId']));
        break;
      case 'polyline#onTap':
        onPolylineTapPlatform(PolylineId(call.arguments['polylineId']));
        break;
      case 'polygon#onTap':
        onPolygonTapPlatform(PolygonId(call.arguments['polygonId']));
        break;
      case 'feature#onTap':
  ...
  Future<void> initPlatform(int id) async {
    _channel = MethodChannel('plugin:vnpt-map-view-type_$id');
  ...
  Widget buildView(
    ...
    if (defaultTargetPlatform == TargetPlatform.android) {
      return AndroidView(
        viewType: 'plugin:vnpt-map-view-type',
