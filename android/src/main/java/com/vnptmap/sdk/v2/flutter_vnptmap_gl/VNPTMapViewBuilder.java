...
public class VNPTMapViewBuilder implements VNPTMapViewOptionsSink {
    ...
    // create build
    VNPTMapViewController build(
            int id,
            Context context,
            BinaryMessenger messenger,
            LifecycleProvider lifecycleProvider,
            String accessToken) {
        final VNPTMapViewController controller =
                new VNPTMapViewController(
                        id,
                        context,
                        messenger,
                        lifecycleProvider,
        ...
        controller.setMyLocationTrackingMode(myLocationRenderMode);
